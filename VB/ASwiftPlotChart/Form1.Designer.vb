...
'			Me.timer1.Tick += New System.EventHandler(Me.timer1_Tick);
			...
			' chartControl1
			' 
			swiftPlotDiagram1.AxisX.DateTimeScaleOptions.GridAlignment = CType(DateTimeMeasureUnit.Millisecond, DateTimeGridAlignment)
			swiftPlotDiagram1.AxisX.DateTimeScaleOptions.MeasureUnit = DateTimeMeasureUnit.Millisecond
			swiftPlotDiagram1.AxisX.Label.DateTimeOptions.Format = DateTimeFormat.Custom
			swiftPlotDiagram1.AxisX.Label.DateTimeOptions.FormatString = "ss:f"
